...
#25/01/2024
#Instalación matrix desde su repositorio y actualización del archivo de configuración
apt update
...
echo "server_name: "matrix.equipo1msql.duckdns.org" #cambiar dominio
...
federation_domain_whitelist: #cambiar dominios federados
  ...
  - "equipo2matrix.duckdns.org"" > homeserver.yaml
