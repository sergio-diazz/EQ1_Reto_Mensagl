...
#25/01/2024
#AWS-CLI
#Creacion de VPC con subredes,tablas de enrutamiento,gateways a internet,gateway nat y dos instancias

# Definir variables
NOMBRE_VPC="SergioDVPC"
CIDR_VPC="10.206.0.0/16"
NOMBRE_SUBRED_PUBLICA="SubredPublicaSergio"
CIDR_SUBRED_PUBLICA="10.206.1.0/24"
NOMBRE_SUBRED_PRIVADA="SubredPrivadaSergio"
CIDR_SUBRED_PRIVADA="10.206.2.0/24"
KEY_NAME="reto"
...
#Lanzar instancias (Debian t2.mediu,) en la subred publica
